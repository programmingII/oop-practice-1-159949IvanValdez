/* 159949 Luis Ivan Valdez Anchondo 25/02/2019  02:48pm.*/

import java.util.Scanner; //me permite escanear una entrada por teclado

public class Ejercicio52_SumaTrue{
	public static void main(String[] args){
		...
		if((n1+n2)==n3) System.out.println("El resultado de la suma es: True");// si la condicion se cumple imprime el mensaje
